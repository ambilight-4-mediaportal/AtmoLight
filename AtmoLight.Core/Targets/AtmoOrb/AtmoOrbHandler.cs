    ...
    public bool ChangeEffect(ContentEffect effect)
    {
      switch (effect)
      {
        ...
        case ContentEffect.StaticColor:
          ...
          ChangeColor(red: (byte) gammaCurve[coreObject.staticColor[0]], green: (byte) gammaCurve[coreObject.staticColor[1]], blue: (byte) gammaCurve[coreObject.staticColor[2]]);
          Thread.Sleep(50);
          ChangeColor(red: (byte) gammaCurve[coreObject.staticColor[0]], green: (byte) gammaCurve[coreObject.staticColor[1]], blue: (byte) gammaCurve[coreObject.staticColor[2]]);
          Thread.Sleep(50);
          ChangeColor(red: (byte) gammaCurve[coreObject.staticColor[0]], green: (byte) gammaCurve[coreObject.staticColor[1]], blue: (byte) gammaCurve[coreObject.staticColor[2]]);
            ...
            coreObject.GetCurrentEffect() == ContentEffect.VUMeterRainbow)
        {
          for (var y = 0; y < coreObject.GetCaptureHeight(); y++)
          {
                 ...
                 pixeldata[row + ((coreObject.GetCaptureWidth() - 1)*4) + 2] != 0))
            {
              ...
              ChangeColor(red: (byte) gammaCurve[r], green: (byte) gammaCurve[g], blue: (byte) gammaCurve[b]);
              return;
            }
          }
          ChangeColor(red: 0, green: 0, blue: 0);
        }
        else
        {
          foreach (var lamp in lamps)
